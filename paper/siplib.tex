...
\begin{document}
	...
	\begin{abstract}
		...
		The test set includes SIP instances from eleven different problems arising in applications to power systems, telecommunications, manufacturing, and so on. \siplibtwo\ provides 
		an open-source \julia\ package for modeling SIP problems and writing them in \smps\ format, where 
