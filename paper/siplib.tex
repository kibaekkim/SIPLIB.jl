...
% set shortcuts
\newcommand{\siplibtwo}{\texttt{SIPLIB 2.0}}
\newcommand{\siplib}{\texttt{SIPLIB}}
...
\section{\texttt{Siplib.jl}: Implementation of a \texttt{Julia} package for \siplibtwo} \label{sec:tutorial}
