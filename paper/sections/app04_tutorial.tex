...
\begin{itemize}
	...
	\item download and place the \siplibjl\ package to anywhere in your computer
	\item open a terminal and change working directory to\\ ``\texttt{anywhere-in-your-computer/Siplib/src/}''
