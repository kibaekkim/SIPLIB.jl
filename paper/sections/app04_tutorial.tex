...
\yoc{I move this to appendix. Though this is not fully research-oriented but published MPC papers (e.g., MIPLIB, PySP, DSP, pyomo.dae) contain such contents. I think it is worth to be included in paper at least in appendix. This shows what we have done in terms of implementation very intuitively.}
