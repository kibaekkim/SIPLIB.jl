...
\subsubsection{\dcap: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{DCAP_3_3_3_1}
	\caption{DCAP\_3\_3\_3\_1: Extensive form constraint matrix}
...
\subsubsection{\mptsps: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{MPTSPs_D0_4_1}
	\caption{MPTSPs\_D0\_4\_1: Extensive form constraint matrix}
...
\subsubsection{\sizes: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{SIZES_1}
	\caption{SIZES\_1: Extensive form constraint matrix}
	\label{fig:mptsps_sparsity}
\end{figure}
...
\subsubsection{\smkp: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{SMKP_50_1}
	\caption{SMKP\_50\_1: Extensive form constraint matrix}
...
\subsubsection{\sslp: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{SSLP_4_4_1}
	\caption{SSLP\_4\_4\_1: Extensive form constraint matrix}
...
\subsubsection{\suc: Sparsity pattern (single scenario)}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{SUC_FallWD_1}
	\caption{SUC\_FallWD\_1: Extensive form constraint matrix}
