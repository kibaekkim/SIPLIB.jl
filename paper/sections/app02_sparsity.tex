...
\begin{table}[h]
	\centering
	\caption{\dcap: fully set cardinality based sparsity information}
...
\begin{table}[h]
	\centering
	\caption{\mptsps: fully set cardinality based sparsity information}
...
\begin{table}[h]
	\centering
	\caption{\sizes: fully set cardinality based sparsity information}
...
\begin{table}[h]
	\centering
	\caption{\smkp: fully set cardinality based sparsity information}
...
\begin{table}[h]
	\centering
	\caption{\sslp: fully set cardinality based sparsity information}
...
\begin{table}[H]
	\centering
	\caption{\suc: fully set cardinality based sparsity information}
