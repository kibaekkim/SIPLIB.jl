...
%\yoc{Thanks. This section is written by benchmarking the MIPLIB 2010 paper published on MPC. There is a section like this (Section 4: How to run a test, add a solver, and what the scripts do) so I think the reviewers of MPC may want us to include the section like this. The answers to the questions are discussed in Section \ref{sec:summary}. More detailed manual will be surely accompanied later with the release of this package. This is a brief manual like the one in MIPLIB 2010.}
...
%\yoc{The why/how description is discussed in Section \ref{sec:summary}. This section is only for ``how it is structured" and ``how to utilize." In addition, like MIPLIB \cite{MIPLIB}, Ariyawansa and Felt's SLP library \cite{AF2004}, Dirske and Ferris's MCP library \cite{DF1995}, this kind of paper cannot be fully research-oriented.}
