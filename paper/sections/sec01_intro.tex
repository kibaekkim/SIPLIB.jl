...
%(Contents)
This paper is organized as follows. In Section \ref{sec:sip}, we briefly review SIP. This includes the mathematical formulation with notation, solution methods, and available software packages. In Section \ref{sec:summary}, we provide summary of the test problems for users to quickly catch up what they need without investigating every detail. This consists of brief description with its origin, instance naming rule, problem type based on its components, and sparsity information. Problem specific detail is also provided in Section \ref{sec:prob_desc}. We present the tutorial of the functions provided by \siplibtwo\ in Section \ref{sec:tutorial}. In Section \ref{sec:instance_catalog}, we report the computational results of the accompanied instances in \texttt{SMPS} format. We conclude our research study with provision of future directions to improve this foregoing project in Section \ref{sec:conclusion}. 
