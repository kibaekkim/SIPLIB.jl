...
\kk{This may not deserve a subsection. It can be in a part of Section 1. We need the literature review for stochastic programming.} \yoc{Thanks, I move this here. I think the literature review on SP is not well blended in Introduction. Instead, Section 2: Stochastic Integer Programming is written for that purpose.}
