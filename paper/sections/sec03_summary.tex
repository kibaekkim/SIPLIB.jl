	...
	\resizebox{\textwidth}{!}{%
		\begin{threeparttable}
			...
			\begin{tablenotes}
				...
				\item **We insert numerical value for the predetermined set, e.g., for \sizes, we use $|T|=2$ and for \mptsps, we use $|K_{ij}|=3$. In \airlift, \sdcp, and \suc, all the sets are predetermined based on the given data except for the scenario set $\mathcal{S}$.
			\end{tablenotes}
		\end{threeparttable}
	}
\end{table}
...
\begin{figure}[]
	...
	\subfloat[][AIRLIFT\_3]
	{
		\centering\includegraphics[width=0.45\linewidth]{AIRLIFT_3}
	...
	{
		\centering\includegraphics[width=0.45\linewidth]{SDCP_5_10_FallWD_1}
