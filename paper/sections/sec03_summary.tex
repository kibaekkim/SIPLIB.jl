	...
	\resizebox{\textwidth}{!}{%
		\begin{threeparttable}
			...
			\begin{tabular}{@{}lccccc@{}}
				...
				& Total          & $8\mathcal{S}$           & - & 4(1+$\mathcal{S}$)                    & $2(1+3\mathcal{S})$    \\ \midrule
				\multirow{3}{*}{\cargo\ (\ref{cargo:notation})}   & 1st stage &            &                                &                     &                       \\
				& 2nd stage &              &                &                     &                   \\ \cmidrule(l){2-6} 
				& Total          &            &  &                    &    \\ \midrule
				\multirow{3}{*}{\chem\ (\ref{chem:notation})}   & 1st stage &            &                                &                     &                       \\
				& 2nd stage &              &                &                     &                   \\ \cmidrule(l){2-6} 
				& Total          &            &  &                    &     \\ \midrule				
				...
				\multirow{3}{*}{\phone\ (\ref{phone:notation})}   & 1st stage &            &                                &                     &                       \\
				& 2nd stage &              &                &                     &                   \\ \cmidrule(l){2-6} 
				& Total          &            &  &                    &   \\ \midrule
