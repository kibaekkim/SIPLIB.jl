...
In this section, we describe the test problems provided in \siplibtwo\. This includes problem origin, type, components (variables and constraints), and sparsity for each problem. We discuss the importance of the test problems in order for advances in SIP research study. This section also reflects our philosophy in developing \siplibtwo. \kk{Please state the philosophy..}
...
%We tried to implement the problems as the same as the original references possible. Not all of them, however, are exactly the same mainly due to random parameters and insufficient information. We sometimes needed to guess the missing links and develop our own way to implement the problems. 
...
\subsection{Instance Naming Rules}
