...
function mptspsdata(nScenarios::Integer, INSTANCE::String)::MPTSPsModel

    # Set paths
    cd(dirname(Base.source_path()))
    DATA_DIR = "../DATA/MPTSPs"
    GRAPH_DIR = "$DATA_DIR/MPTSPs_$INSTANCE"  #
...
function mptsps_flow(nScenarios::Integer, INSTANCE::String)::JuMP.Model
    # get model data
    tsp = mptspsdata(nScenarios, INSTANCE)
